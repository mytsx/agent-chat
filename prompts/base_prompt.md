...
The `room` parameter is auto-configured via environment — you do NOT need to pass it.
...
- IMPORTANT: Always use your assigned agent_name consistently in all tool calls
